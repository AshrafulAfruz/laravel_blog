...
<link rel="stylesheet" href="{{asset('website')}}/css/main.css">
    ...
    <script defer src="{{asset('website')}}/js/fontawesome/all.min.js"></script>
        ...
        <div class="row">
            ...
            <div class="s-header__content column">
                <h1 class="s-header__logotext">
                    <a href="index.html" title="">Laravel Blog Practice.</a>
                </h1>
                <p class="s-header__tagline">Here I come!.</p>
            </div>
       ...
       <nav class="s-header__nav-wrap">
           ...
           <div class="row">
                ...
                <ul class="s-header__nav">
                    ...
                    <li class="{{\Route::current()->getName()=="website.home"? 'current':''}}"><a href="index.html">Home</a></li>
                    ...
                    <li class="has-children {{\Route::current()->getName()=="website.category" || \Route::current()->getName()=="website.post"? 'current':''}}"><a href="#0">Blog</a>
                        <ul>
                ...
                <div class="row">
                    <div class="large-8 tab-full column">
                        ...
                        <ul class="photostream group">
                            <li><a href="#0"><img alt="thumbnail" src="{{asset('website')}}/images/thumb.jpg"></a></li>
                            <li><a href="#0"><img alt="thumbnail" src="{{asset('website')}}/images/thumb.jpg"></a></li>
                            <li><a href="#0"><img alt="thumbnail" src="{{asset('website')}}/images/thumb.jpg"></a></li>
                            <li><a href="#0"><img alt="thumbnail" src="{{asset('website')}}/images/thumb.jpg"></a></li>
                            <li><a href="#0"><img alt="thumbnail" src="{{asset('website')}}/images/thumb.jpg"></a></li>
